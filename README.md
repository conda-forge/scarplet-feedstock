About scarplet-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/scarplet-feedstock/blob/main/LICENSE.txt)
...
Development: http://github.com/rmsare/scarplet

Documentation: https://scarplet.readthedocs.io
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4586&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scarplet-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scarplet` can be installed with `conda`:
...
```
mamba install scarplet
```

It is possible to list all of the versions of `scarplet` available on your platform with `conda`:
...
```
mamba search scarplet --channel conda-forge
```
...
mamba repoquery search scarplet --channel conda-forge

# List packages depending on `scarplet`:
mamba repoquery whoneeds scarplet --channel conda-forge

# List dependencies of `scarplet`:
mamba repoquery depends scarplet --channel conda-forge
```
...
* [@rmsare](https://github.com/rmsare/)
